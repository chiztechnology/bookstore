...
<div align="center">
  <h1><b>React project "Book store"<hb>
...
> this is an exercise Project designed to create step by step a simple React app of a Book store
...
Clone this repository to your desired folder: by typing `git clone https://github.com/chiztechnology/bookstore.git` in the folder of you're choice
...
- **Update design and create better UI/Ux**
- **Save books in localstorage**
- **Display books status in category navigation menu**
